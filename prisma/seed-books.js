...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var count, _i, books_1, book, existing;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    book = books_1[_i];
                    return [4 /*yield*/, prisma.resource.findFirst({ where: { title: book.title } })];
                case 2:
                    existing = _a.sent();
                    if (!!existing) return [3 /*break*/, 4];
                    return [4 /*yield*/, prisma.resource.create({ data: book })];
                case 3:
                    _a.sent();
                    count++;
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, prisma.resource.update({
